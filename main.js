...
const setingsModal = document.querySelector('.setings-modal');
...
setings.addEventListener('click', function setingsClick(){
     i = 1;
     setingsModal.classList.add('setings-modal-active');
     document.addEventListener('click', closeSettigs);
})

function closeSettigs(event){
    if(event.target !== setingsModal){
         
        console.log(i);
        if(i!==1){setingsModal.classList.remove('setings-modal-active');}
        i++;
